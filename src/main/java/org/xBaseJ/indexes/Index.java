 ...
 *     <p>Change History Date Developer Desc 20091007 Roland Hughes (rth) Made a patch to make date
 *     index work. The way things are, Date and Numeric will only work if they are keys by
 *     themselves. If you need dates or numbers to be part of a segmented key you need to declare
 *     them as Character columns. 20091007 joe mcverry (jrm) Corrected error in checking date
 *     indexing.
 *     <p>20110401 joe mcverry (jrm) Moved unique_key check to before building a key.
 */
import java.io.File;
