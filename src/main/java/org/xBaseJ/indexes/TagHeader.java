...
public class TagHeader {
  ...
  /* int:3; */
  /* int desc:1; */
  /* 1 if DESCENDING, or 0 */
  /* int Fieldtag:1; */
  /* 1 if tag is a Field, or 0 */
  /* int:1; */
  /* int unique_key_bit:1; */
  /* 1 if Index is UNIQUE, or 0 */
  /* int:1; */
  ...
  public TagHeader(MDXFile ifile, short ipos, short len, char type, boolean unique)
      throws IOException {
    mfile = ifile;
    nfile = ifile.raFile;
    setPos(ipos);
