...
public class PictureField extends Field {
  ...
  /**
   * public method for creating a picture field object. It is not associated with a database but can
  ...
  /**
   * sets the contents of the picture Field, variant of the field.put method data not written into
   * DBF until an update or write is issued.
   *
