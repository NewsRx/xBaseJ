...
public class NumField extends Field {
  ...
  /**
   * public method for creating a numeric field object. It is not associated with a database but can
   * be when used with some DBF methods.
   *
   * @param iName the name of the field
   * @param iLength the length of Field. range is 1 to 19 bytes
   * @param inDecPosition the number of decimal positions range from 2 to 17 bytes. Relative to
   *     Length.
   * @throws xBaseJException bad name, length or decimal positions specified
