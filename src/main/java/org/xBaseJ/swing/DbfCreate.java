	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == menuOpen) {
			...
			try {
				...
				JOptionPane.showMessageDialog(this, xex.getMessage(), "xBaseJException Occurred",
						JOptionPane.ERROR_MESSAGE);
				repaint();
				return;
			} catch (IOException ioex) {
				JOptionPane.showMessageDialog(this, ioex.getMessage(), "IOException Occurred",
						JOptionPane.ERROR_MESSAGE);
				repaint();
				return;
			}
		...
		if (ae.getSource() == menuCreate) {
			...
			if (fil.exists()) {
				int resp = JOptionPane.showConfirmDialog(this,
						"File " + fil.getName() + " already exists.  Do you want to replace it?", "File Already Exists",
			...
			try {
				...
				JOptionPane.showMessageDialog(this, nfex.getMessage(), "NumberFormatException Occurred",
						JOptionPane.ERROR_MESSAGE);
				repaint();
				this.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
				return;
	...
	*/
	...
	public void setValueAt(Object in, int r, int c) {
		...
		case 1:
			...
			String s = (String) in;
			if ((s.compareTo("Logical") == 0) || (s.compareTo("Memo") == 0) || (s.compareTo("Picture") == 0)
