...
public class XBASEXMLParser extends DefaultHandler {
  ...
  /**
   * constructor, sets up SAX parser, turns off validation, turns on namespaces, sets up content
   * handler and error handler as this object. sax exceptions go to System.err
   */
  ...
  /**
   * catches warning SAXParseExceptions this code sends exception to stdio and allows public classto
   * continue
   *
