...
public class DBT_fpt extends DBTFile {
	...
	/**
	 * Default block size for FPT is 64.
	 * @param iDBF
	 * @param readOnly
	 * @param memoBlockSize
	 * @throws IOException
	...
	/**
	 * foxpro default memo block size = 64
	 * 
	 * @param iDBF
	 * @param name
	 * @param memoBlockSize
	 ...
	 * @throws xBaseJException
	 */
	public DBT_fpt(DBF iDBF, String name, boolean destroy, int memoBlockSize) throws IOException, xBaseJException {
		super(iDBF, name, destroy, DBFTypes.FOXPRO_WITH_MEMO, 64);
		nextBlock = 8;
