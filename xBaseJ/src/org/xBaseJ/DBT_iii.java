...
public class DBT_iii extends DBTFile {
	...
	/**
	 * Open for reading an existing Memo file.
	 * @param iDBF
	 * @param readOnly
	 * @throws IOException
	 ...
	 * @param name
	 * @param destroy
	 * @param memoBlockSize Standard default is 512 bytes.
	 * @throws IOException
	 * @throws xBaseJException
	 */
	public DBT_iii(DBF iDBF, String name, boolean destroy, int memoBlockSize) throws IOException, xBaseJException {
		super(iDBF, name, destroy, DBFTypes.DBASEIII_WITH_MEMO, memoBlockSize);
	}
