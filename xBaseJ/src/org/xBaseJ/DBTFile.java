...
public abstract class DBTFile extends Object {
	...
	public File thefile;
	/**
	 * Allocation size for data stored in memo files. <strong>Never change this value after it is set at memo file creation!</strong>
	 */
	...
	/**
	 * Open memo file for reading.
	 * @param iDBF
	 * @param readonly
	 * @param foxproWithMemo
	 * @throws IOException
	 ...
	 * @throws xBaseJException
	 */
	public DBTFile(DBF iDBF, String name, boolean destroy, DBFTypes type, int memoBlockSize)
