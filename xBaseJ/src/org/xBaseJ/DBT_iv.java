...
public class DBT_iv extends DBTFile {
	 ...
	 * @throws xBaseJException
	 */
	public DBT_iv(DBF iDBF, String name, boolean destroy, int memoBlockSize) throws IOException, xBaseJException {
		super(iDBF, name, destroy, DBFTypes.DBASEIV_WITH_MEMO, memoBlockSize);
		nextBlock = 1;
